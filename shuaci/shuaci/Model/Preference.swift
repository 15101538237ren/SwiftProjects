...
struct Preference: Codable {
    ...
    init(auto_pronunciation: Bool = true, us_pronunciation:Bool = true, number_of_words_per_group: Int = 20, current_theme: Int = 1, memory_order:Int = 1, current_book_id: String? = nil, reminder_time:Date? = nil) {
