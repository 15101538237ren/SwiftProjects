...
//                vc.modalTransitionStyle = .coverVertical//.crossDissolve
...
class RPickerController: BottomPopupViewController {
    
    override var popupHeight: CGFloat { return CGFloat(250) }
    ...
    private func initialSetup() {
        ...
        bgView.backgroundColor = UIColor(white: 1.0, alpha: 0.4)
        ...
        let height = barViewHeight + pickerHeight + (2*lineHeight) + 30.0
