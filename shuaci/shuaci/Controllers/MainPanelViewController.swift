...
class MainPanelViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let user = LCApplication.default.currentUser {
            ...
            var nickname:String = "欢迎您"
            if let name = user.get("nickname"){
            ...
            switch hour {
            case 6..<12 : greeting = NSLocalizedString("早上好", comment: "早上好")
            case 12 : greeting = NSLocalizedString("中午好", comment: "中午好")
            case 13..<17 : greeting = NSLocalizedString("下午好", comment: "下午好")
            default: greeting = NSLocalizedString("晚上好", comment: "晚上好")
            }
    ...
    @objc func moveCard() {
            ...
            mainPanelUIView.bringSubviewToFront(cards[currentIndex % 2])
            card.alpha = 1
        }
