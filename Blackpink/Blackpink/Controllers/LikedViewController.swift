...
class LikedViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate {
    // Outlet Variables
    ...
    @objc func load(){
        ...
        if connected{
            ...
            let predicate = NSPredicate(format: "issued = 1 AND recordID IN %@", recordReferences)
...
extension LikedViewController: PopMenuViewControllerDelegate {
